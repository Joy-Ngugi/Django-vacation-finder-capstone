...
//                   {/* <td className="border px-4 py-2 font-bold text-blue-600">{booking.booking_code}</td> */}
...
//                   {/* <td className="border px-4 py-2 font-bold text-green-600">{booking.status}</td> */}
...
//                     >
//                       <option classname="font-bold text-green-600" value="Pending">Pending</option>

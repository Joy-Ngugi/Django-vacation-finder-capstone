        ...
        <div className="hidden peer-checked:flex lg:flex flex-col lg:flex-row items-center space-y-4 lg:space-y-0 lg:space-x-6 md:text-1xl sm:text-1xl ">
          {user ? (
            <>
              ...
              <Link to="/" className="hover:bg-blue-300   p-2 rounded-lg font-semibold">
                Home
              </Link>
              <Link to="/maps" className="hover:bg-blue-300  p-2 rounded-lg font-semibold">
                Maps
              </Link>
              <Link to="/profile" className="hover:bg-blue-300  p-2 rounded-lg font-semibold">
               Profile
              </Link>
            ...
            <>
              ...
              <Link to="/login" className="hover:bg-blue-300  p-2 rounded-lg font-semibold">
                Login
              </Link>
              <Link to="/signup" className="hover:bg-blue-300  p-2 rounded-lg font-semibold">
                Sign up
              </Link>

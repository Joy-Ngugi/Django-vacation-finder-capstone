...
urlpatterns = [
    ...
    path('ratings/<int:id>/', RatePlaceView.as_view(), name='rate-place'),
    ...
    path('user/bookings/<int:user_id>/', views.user_bookings, name='user_bookings_by_id'),
    path('admin/ratings/', views.get_all_ratings, name='admin-ratings'),
]